...
function createFiltersTemplate(currentFilterType) {
  return (`<form class="trip-filters" action="#" method="get">
                ...
                <div class="trip-filters__filter">
                  <input id="filter-present" class="trip-filters__filter-input  visually-hidden" type="radio" name="trip-filter" value="${FilterType.PRESENT}" ${currentFilterType === FilterType.PRESENT ? 'checked' : ''}}>
